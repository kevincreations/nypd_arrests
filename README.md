...
- Column names were standardized in Excel for clarity.
- Formatted the date column in Excel to ensure it was compatible with SQL analysis.
- Manipulated data with UPDATE statements and CASE expressions to standardize categorical values, replace abbreviations with descriptive labels, and handle missing data (NULL and '(null)' values).
